...
FFMPEG_PATH = $$PWD/../OtherLibs/ffmpeg
FFMPEG_LIB  = $$FFMPEG_PATH/lib/win/$$PLATFORM

CONFIG(debug, debug|release){
    FASTVIDEO_LIB  = -L$$FASTVIDEO_SDK/lib/$$PLATFORM/Debug
    FASTVIDEO_DLL_PATH = $$FASTVIDEO_SDK/bin/$$PLATFORM/Debug
...
CUDA_TOOLKIT_PATH = "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v10.0"
CUDAINC += $$CUDA_TOOLKIT_PATH/include
CUDA_DLL_PATH = $$CUDA_TOOLKIT_PATH/bin
CUDA_DLL += $$CUDA_DLL_PATH/cudart64_100.dll

CUDA_DLL += $$CUDA_DLL_PATH/nppc64_100.dll
CUDA_DLL += $$CUDA_DLL_PATH/nppif64_100.dll
CUDA_DLL += $$CUDA_DLL_PATH/nppicc64_100.dll
CUDA_DLL += $$CUDA_DLL_PATH/nppig64_100.dll
