...
Currently the software is working with <a href="https://www.ximea.com" target="_blank">XIMEA</a> cameras. Soon we are going to add support for JAI and Imperx cameras. You can add support for desired cameras by yourself. The software is working with demo version of Fastvideo SDK, that is why you can see a watermark on the screen. To get a license for the SDK, please contact <a href="https://www.fastcompression.com/" target="_blank">Fastvideo company</a>.

## How to build gpu-camera-sample.  

### Requirements for Windows

* Camera SDK (XIMEA, Flir, Baumer, JAI, Imperx, etc. (currently only XIMEA is supported))
...
gpu-camera-sample is a multy threaded application. It consists of the following threads:

* Main application thread controls application GUI and other threads.
* Image acquisition from a camera thread controls camera data acquisition and CUDA-based image processing thread.
...
* Async data writing thread. Writes processed JPEG data to SSD or streaming
